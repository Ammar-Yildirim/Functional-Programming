...
issum :: Int Int Int -> Int
issum x y z = (x == y+z) || (y==x+z) || (z==x+y) // || these slashes are used for OR
...
// 8. Say Hello to the World!  				// +++ glues together strings
...
ch :: Char -> Char
ch c
| 65 <= toInt c && toInt c <= 90 = toLower c  // the interval is there, converting characters into ACII and compare thme with their code
...
lastDigit :: Int -> Int
lastDigit x = x rem 10 					// just the remainder
...
check a b c = (isEven a) && (b rem 13 == 0) && c		// Functions take bool values
...
addn :: Int -> Int
addn n
| n <= 0 = abort "N cannot be zero or negative"
| n == 1 = 1
= n + addn (n-1)
...
sumDigits :: Int -> Int
sumDigits x
| x < 0 = abort " No negatives " 
| x<10 = x
= (x rem 10) + sumDigits (x/10) // remainder takes out the last digit, the other is integer division
...
// 765 + 10^3 = 76500 + 432 = 765432

glue2 :: Int Int -> Int
glue2 x y = toInt(toString x +++ toString y)
...
sumOdd :: Int -> Int
sumOdd n 
| n <= 0 = abort "has to be positive"
| n ==1 = 1
| (n > 0) && isEven n = sumOdd (n-1)
| (n > 0) && isOdd n = n + sumOdd (n-2)


//Start = sumOdd 5 // 9 
//Start = sumOdd 21 // 121
//tart = sumOdd 10 // 25 = 9+7+5+3+1
...
//Friday evening HW1 Teams  is graded,1 week to solve
// progress tasks, 15 min
